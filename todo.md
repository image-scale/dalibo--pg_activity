...
- [ ] Task 7: Terminal rendering with blessed - header display with server stats, process table with columns, footer with help keys, color-coded output, query wrapping
